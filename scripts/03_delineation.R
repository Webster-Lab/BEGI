...
tempdat = BEGI_EXO.or2[["SLOC"]][BEGI_EXO.or2[["SLOC"]]$datetimeMT > as.POSIXct(i, "00:00:01 MDT") &
                                   BEGI_EXO.or2[["SLOC"]]$datetimeMT < (as.POSIXct(i, "00:00:01 MDT") +(60*60*24)),]

#save plot 
file_name = paste("plots/delineations/SLOC_", i, ".png", sep="")
png(file_name)
